...
# Delete rte include
$DeleteNode = (((((((($xml.cproject.storageModule.cconfiguration|where {$_.id -eq "com.atollic.truestudio.exe.debug.1984525199"}).storageModule|where {$_.moduleId -eq "cdtBuildSystem"}).configuration|where {$_.name -eq "BUILD"}).folderInfo.toolChain)|where {$_.name -eq "Atollic ARM Tools"}).tool|where {$_.name -eq "C Linker"}).option|where {$_.name -eq "Libraries"}).listOptionValue|where {$_.value -eq "ewrte-m7-gcc"})
if($DeleteNode) { $target.RemoveChild($DeleteNode) | Out-Null }
...
$DeleteNode = (((((((($xml.cproject.storageModule.cconfiguration|where {$_.id -eq "com.atollic.truestudio.exe.debug.1984525199"}).storageModule|where {$_.moduleId -eq "cdtBuildSystem"}).configuration|where {$_.name -eq "BUILD"}).folderInfo.toolChain)|where {$_.name -eq "Atollic ARM Tools"}).tool|where {$_.name -eq "C Linker"}).option|where {$_.name -eq "Libraries"}).listOptionValue|where {$_.value -eq "ewgfx-m7-gcc"})
if($DeleteNode) { $target.RemoveChild($DeleteNode) | Out-Null }

$DeleteNode = (((((((($xml.cproject.storageModule.cconfiguration|where {$_.id -eq "com.atollic.truestudio.exe.debug.1984525199"}).storageModule|where {$_.moduleId -eq "cdtBuildSystem"}).configuration|where {$_.name -eq "BUILD"}).folderInfo.toolChain)|where {$_.name -eq "Atollic ARM Tools"}).tool|where {$_.name -eq "C Linker"}).option|where {$_.name -eq "Libraries"}).listOptionValue|where {$_.value -eq "ewgfx-m7-r90-gcc"})
if($DeleteNode) { $target.RemoveChild($DeleteNode) | Out-Null }

$DeleteNode = (((((((($xml.cproject.storageModule.cconfiguration|where {$_.id -eq "com.atollic.truestudio.exe.debug.1984525199"}).storageModule|where {$_.moduleId -eq "cdtBuildSystem"}).configuration|where {$_.name -eq "BUILD"}).folderInfo.toolChain)|where {$_.name -eq "Atollic ARM Tools"}).tool|where {$_.name -eq "C Linker"}).option|where {$_.name -eq "Libraries"}).listOptionValue|where {$_.value -eq "ewgfx-m7-r180-gcc"})
if($DeleteNode) { $target.RemoveChild($DeleteNode) | Out-Null }

$DeleteNode = (((((((($xml.cproject.storageModule.cconfiguration|where {$_.id -eq "com.atollic.truestudio.exe.debug.1984525199"}).storageModule|where {$_.moduleId -eq "cdtBuildSystem"}).configuration|where {$_.name -eq "BUILD"}).folderInfo.toolChain)|where {$_.name -eq "Atollic ARM Tools"}).tool|where {$_.name -eq "C Linker"}).option|where {$_.name -eq "Libraries"}).listOptionValue|where {$_.value -eq "ewgfx-m7-r270-gcc"})
if($DeleteNode) { $target.RemoveChild($DeleteNode) | Out-Null }
