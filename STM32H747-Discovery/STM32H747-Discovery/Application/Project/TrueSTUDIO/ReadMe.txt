...
*
*   This package is prepared and tested for the STM32H747 Discovery board.
*
*******************************************************************************/
...
- The following steps are needed to establish this automatic project import:
  ...
  * Select the profile and set the attribute PostProcess to the following file:
    ..\..\Application\Project\TrueSTUDIO\STM32H747-Discovery\TrueSTUDIO_ew_post_process.cmd
...
- Import of the project to Atollic TrueSTUDIO
  * The given TrueSTUDIO Example under \Application\TrueSTUDIO contains a
    ...
    3. Choose 'Select root directory' - 'Browse' and select the directory
       \Application\Project\TrueSTUDIO\STM32H747-Discovery
    4. Press 'Finish'
...
- The delivered TrueSTUDIO project uses the STM32CubeProgrammer CLI interface to
  flash the application to the connected device.
  The 'External Tool Configuration' uses the default path to STM32CubeProgrammer
  program folder. If your STM32CubeProgrammer is not installed at the default path,
