...
::
::
:: Embedded Wizard Post Process script for automatic updating of the TrueSTUDIO
...
PowerShell.exe -ExecutionPolicy Bypass -Command "& '%realativepath%\TrueSTUDIO_ew_post_process_power_shell_script.ps1'"
...
if ERRORLEVEL == 6 (
 echo !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 echo The TrueSTUDIO project was not found!
 echo !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 exit /B 1
)
