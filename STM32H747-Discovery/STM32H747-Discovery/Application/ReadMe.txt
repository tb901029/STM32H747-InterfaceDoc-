...
How to build a demo using this template for the STM32H747 Discovery board:
--------------------------------------------------------------------------

The STM32H747 target provides only a small on-chip flash memory. A small bootloader
is necessary to start the code execution from QSPI flash.
...
This has to be done only once - then you can continue with the following steps:
